...
namespace Nop.Data.Migrations
{
    ...
    public partial class MigrationManager : IMigrationManager
    {
        ...
        protected virtual IEnumerable<IMigrationInfo> GetMigrations(Assembly assembly, MigrationProcessType migrationProcessType = MigrationProcessType.DoesNotMatter)
        {
            var migrations = _filteringMigrationSource
                .GetMigrations(t =>
                {
                    ...
                    if (migrationAttribute.TargetMigrationProcess != MigrationProcessType.DoesNotMatter &&
                        migrationProcessType != MigrationProcessType.DoesNotMatter &&
